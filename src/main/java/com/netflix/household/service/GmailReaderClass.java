...
class GmailReaderClass {
    ...
    public static final String CREDENTIALS_FILE_PATH = System.getProperty("user.dir") + "\\env\\creds.json";

    public static final String TOKENS_DIRECTORY_PATH = System.getProperty("user.dir") + "\\env";
    /**
